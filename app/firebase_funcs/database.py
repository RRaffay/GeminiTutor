...
def delete_class_from_user(uid, class_name):
    ...
    if class_name in user_data['classes']:
        user_data.get('classes', {}).remove(class_name)
        user_data.get('first_visit', {}).pop(class_name, None)
        user_data.get('goals', {}).pop(class_name, None)
        user_data.get('course_descriptions', {}).pop(class_name, None)
        user_data.get('current_questions', {}).pop(class_name, None)
        user_data.get('old_questions', {}).pop(class_name, None)
        user_data.get('recommendations', {}).pop(class_name, None)
        doc_ref.update(user_data)
